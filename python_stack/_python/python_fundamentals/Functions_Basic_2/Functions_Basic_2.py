...
def print_and_return(lista):
    print("The first num is" , lista[0])
    return lista[1]
x = print_and_return([1,2])
print("The second num is" , x , "returned and printed",)
...
def values_greater_than_second(lista):
    ...
    print ("num of values greater than the second element =" , len(lista2))
    return  lista2

x = values_greater_than_second([5,2,3,2,1,4])
print("returned list =" , x )
