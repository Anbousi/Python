...
#Bounus all routes in one route
@app.route("/")
@app.route("/play/<times>")
@app.route("/play/<times>/<color1>")
def repeat_1(times = 3 , color1="aqua"):
    return render_template("index.html" , times = int(times) , color = color1)
